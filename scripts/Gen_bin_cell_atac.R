...
Gen_bin_cell_atac=function(bin_bed=NULL, barcodes=NULL, path_to_fragments="./fragments.tsv.gz" ){
# generate bin by cell matrix from fragment file
barcodes=barcodes$V1

cat("Read fragment file...\n")
fragments <- import.bed(path_to_fragents, extraCols = c( "type"="character", "type"="integer"))
